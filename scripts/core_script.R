...
wood<-unique(fread("Raw_data/EUForestspecies.csv", select = c("X","Y", "SPECIES NAME"))) #raw data can be obtained from https://figshare.com/collections/A_high-resolution_pan-European_tree_occurrence_dataset/3288407
